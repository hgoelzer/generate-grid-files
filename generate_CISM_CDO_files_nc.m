...
[LI_grid_center_lat,LI_grid_center_lon]=polarstereo_inv(...
    xcenters(:)-proj_info.falseeasting+dx/2,...
    ycenters(:)-proj_info.falsenorthing+dy/2,...
...
[LI_grid_corner_lat,LI_grid_corner_lon]=polarstereo_inv(...
    xcorners(:)-proj_info.falseeasting+dx/2,...
    ycorners(:)-proj_info.falsenorthing+dy/2,...
    proj_info.earthradius,proj_info.eccentricity,...
    proj_info.standard_parallel,...
    proj_info.longitude_rot);
...
%% write 2D and 1d x,y
wnc(xcenters-proj_info.falseeasting+dx/2,grid.xyOutputFileName,'x2','m','grid center x-coordinate',{'x1','y1'},0,'classic')
wnc(ycenters-proj_info.falsenorthing+dy/2,grid.xyOutputFileName,'y2','m','grid center y-coordinate',{'x1','y1'},0,'classic')

wnc(squeeze(xcenters(:,1))-proj_info.falseeasting+dx/2,grid.xyOutputFileName,'x1','m','grid center x-coordinate','x1',0,'classic')
wnc(squeeze(ycenters(1,:))-proj_info.falsenorthing+dy/2,grid.xyOutputFileName,'y1','m','grid center y-coordinate','y1',0,'classic')
