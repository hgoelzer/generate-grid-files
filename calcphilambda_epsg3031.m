...
ncwriteatt(af2_file_name,'/','Description','Area scaling factor (af2) for ISMIP6 Antarctic grid. Multiply with 2D data to correct the projection error. af2=(1/k)^2, where k is the map scale factor. Calculated after Snyder (1987) by Heiko Goelzer, IMAU, April 2018.')
